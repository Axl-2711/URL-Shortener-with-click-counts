...
import { handleDeleteShortUrl, handleGenerateShortenerID, reDirectToURL, handleGetAnalytics } from "../Controllers/url-Shortener.js";
...
urlRouter.post("/delete/:shortID", restrictToLoggedinUserOnly, handleDeleteShortUrl);
